...
function AddStudentDepartment() {
  ...
  const handleChange = (e, { value }) => {
    setStudentDepartmentName(value);
  };
  return (
    <>
      <CustomMenu title="Add a Student Department" />
      <div
        style={{
          display: "flex",
          flexDirection: "row",
      ...
      >
        <Form style={{ width: "50%" }}>
          ...
          <Form.Field>
          <label style={{ color: "#0e2a45", fontWeight:"700", textAlign:"center", marginTop:20, marginBottom:20 }}>Assign an HOD to this department</label>

          </Form.Field>
          <Form.Field>
            <label style={{ color: "#0e2a45" }}>Email Address of the HOD</label>
            <Form.Input
              style={{ height: 50 }}
          ...
          <Message
            style={{ marginTop: 20 }}
            info
            header={'CAS Login Details for iyiolaema@gmail.com'}
            list={[
...
export default AddStudentDepartment;
